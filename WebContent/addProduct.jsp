	...
	<div class="container">
		<div class="text-right">
			 ...
			 <!--   <a href="?language=ko" >Korean</a> -->
			  <button type="button" class="btn btn-outline-primary" onclick="location.href='?language=ko' ">Korean</button>
			
			<!--   <a href="?language=en" >English</a> 
			-->
			  <button type="button" class="btn btn-outline-primary" onclick="location.href='?language=en' ">English</button>
